      ...
      <div>
         <footer className='footer'>
            <ul className='footer-nav'>
               ...
               <li>
                  <a className='footer-links' target='_blank' href='https://github.com/resant18'>
                     <img src={window.social["github"]}></img>
                  </a>
               </li>
               <li>
                  <a className='footer-links' target='_blank' href='https://www.linkedin.com/in/renata-santoso/'>
